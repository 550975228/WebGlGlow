...
Matrix4.prototype = {
    ...
    getPosition: function () {
        ...
        var te = this.elements;
        return Matrix4.__v1.set( te[12], te[13], te[14] );
    ...
    getColumnX: function () {
        ...
        var te = this.elements;
        return Matrix4.__v1.set( te[0], te[1], te[2] );
    ...
    getColumnY: function () {
        ...
        var te = this.elements;
        return Matrix4.__v1.set( te[4], te[5], te[6] );
    ...
    getColumnZ: function() {
        ...
        var te = this.elements;
        return Matrix4.__v1.set( te[8], te[9], te[10] );
    ...
    compose: function ( translation, rotation, scale ) {
        ...
        var te = this.elements;
        var mRotation = Matrix4.__m1;
        var mScale = Matrix4.__m2;
